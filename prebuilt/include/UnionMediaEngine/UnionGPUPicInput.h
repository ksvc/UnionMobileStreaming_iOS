 ...
 * 支持图像旋转
 */
@interface UnionGPUPicInput : GPUImageOutput
...
/**
 ...
 @discussion 直接连接到UnionGPUPicMixer时, 旋转90度的情况可能出现问题, 请尽量保证中间有其他滤镜
 */
...
/** GPU图像输输入
 过期的类, 请使用UnionGPUPicInput
 */
@interface UnionGPUYUVInput : UnionGPUPicInput
@end
