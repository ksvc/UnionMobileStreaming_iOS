 ...
 * @abstract  音效类型
 */
typedef NS_ENUM(NSUInteger, UnionAudioEffectType){
    /// 初始化时状态为空闲
    UnionAudioEffectType_NONE = 0,
    /// 大叔
    UnionAudioEffectType_MALE,
    /// 萝莉
    UnionAudioEffectType_FEMALE,
    /// 宏大
    UnionAudioEffectType_HEROIC,
    /// 机器人
    UnionAudioEffectType_ROBOT,
};
 ...
 */
@interface UnionAUAudioCapture : NSObject
