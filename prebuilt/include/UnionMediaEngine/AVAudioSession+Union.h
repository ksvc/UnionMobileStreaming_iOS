 ...
 */
typedef NS_ENUM(NSUInteger, UnionMicType) {
    /// Built-in microphone on an iOS device
    UnionMicType_builtinMic = 0,
    /// Microphone on a wired headset
    UnionMicType_headsetMic,
    /// 蓝牙设备
    UnionMicType_bluetoothMic,
    
    /// 未知设备
    UnionMicType_unknow = 1000,
};


#import <AVFoundation/AVFoundation.h>
//#import "UnionTypeDef.h"
...
@interface AVAudioSession (Union)
...
/**
 ...
 @discussion 参考 UnionMicType
 */
@property UnionMicType currentMicType;
